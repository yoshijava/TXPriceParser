...
public class Util {
    ...
    public static void print(int op, String s) {
        if ((op & tarOp) != 0) {
            if (op == E) {
                ...
                if (printTS) System.out.print(format(new Date(), "MMdd HH:mm:ss") + sep);
                System.out.print(s);
            } else if (op <= 8) {
                System.out.print(opTag[op - 1] + sep);
                if (printTS) System.out.print(format(new Date(), "MMdd HH:mm:ss") + sep);
                System.out.print(s);
            }
        }
    ...
    public static void logT(int op, String tag, String fmt, Object... obj) {
        println(op, tag + sep + String.format(fmt, obj));
    }

    public void log(int op, String fmt, Object... obj) {
        println(op, cname + sep + String.format(fmt, obj));
    }

    public void log(String fmt, Object... obj) {
        log(E, cname + sep + String.format(fmt, obj));
    }

    public void dbg(String fmt, Object... obj) {
        if (dbg) log(cname + sep + String.format(fmt, obj));
    }
